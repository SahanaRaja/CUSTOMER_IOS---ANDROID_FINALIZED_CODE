...
class ResSubCategoryItems {
  ...
  factory ResSubCategoryItems.fromMap(Map<String, dynamic> data) {
    return ResSubCategoryItems(
  ...
  factory ResSubCategoryItems.fromJson(String data) {
    return ResSubCategoryItems.fromMap(
