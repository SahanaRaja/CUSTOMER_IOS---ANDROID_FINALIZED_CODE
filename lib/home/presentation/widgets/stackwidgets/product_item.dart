...
class ProductItempage extends StatefulWidget {
  ...
  ProductItempage({Key? key, required this.actualHeight}) : super(key: key);
                ...
                children: [
                  ...
                  13.5,
                      ...
                      child: ListView.builder(
                          ...
                          {
                           // shopController.setsupercatagoryIndex(shopController.subcatagoryIndex.value);
                           ...
                           // optionsController.optionIndexSetter(4);
                            optionsController.setSetState();
                            viewController.setView(PRODUCTRESITEM);
                             configureController.subheaderResponse.value = shopController
                                              .resitem[shopController
                                                          .supercatagoryIndex.value]
                                              .category![shopController
