...
class SetPasswordTab extends StatefulWidget {
  ...
  @override
  _SetPasswordTabTabState createState() => _SetPasswordTabTabState();
}

class _SetPasswordTabTabState extends State<SetPasswordTab> {
              ...
              children: [
                InkWell(
                    onTap: () {
                     ...
                     headerController.setSubHeaderLabel('Verify Mail Id');
                    ...
                    child: Container(
                      ...
                      child: TextFormField(
                        ...
                        onTap: () {
                          ...
                          keyboardController
                              .setcreatePassController(widget.newPass);
                          keyboardController.symbolTrue(true);
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: languageController
                              .languageResponse.value.repeatPassword,
                          counterText: "",
                          suffixIcon: GestureDetector(
                            onTap: () {
                              setState(() {
